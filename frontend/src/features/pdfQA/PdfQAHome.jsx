    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-cyan-50/30 to-teal-50/50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          {/* Subject Q&A Card */}
          <button
            onClick={() => navigate('/pdf-qa/subject')}
          ...
          >
            ...
            <p className="text-slate-600 dark:text-slate-400 mb-6 text-left">
              Ask questions about pre-loaded subjects like DSA, OS, DBMS, Machine Learning, and more
            </p>
          ...
          {/* Upload PDF Card */}
          <button
            onClick={() => navigate('/pdf-qa/upload')}
          ...
          >
            ...
            <p className="text-slate-600 dark:text-slate-400 mb-6 text-left">
              Upload your own PDF documents and ask questions about them with AI assistance
            </p>
