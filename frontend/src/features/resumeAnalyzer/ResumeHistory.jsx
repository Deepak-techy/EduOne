...
//   const mainGradient = 'linear-gradient(135deg, rgb(32,158,255), rgb(130,202,212))';
...
//               fontSize: '0.9rem',
//               fontWeight: 700,
//               color: isBackHovered ? '#036672' : '#0891b2',
//               cursor: 'pointer',
//               marginBottom: '2px',
//               transition: 'color 0.2s',
//             }}
//           >
//             <ArrowLeft size={30} color={isBackHovered ? '#036672' : '#0891b2'} />
//           </button>
...
//                 fontWeight: 700,
//                 cursor: 'pointer',
//                 boxShadow: '0 4px 16px rgba(6,182,212, 0.24)',
//                 transition: 'all 0.3s',
//                 display: 'inline-flex',
//                 alignItems: 'center',
//                 gap: '10px',
...
//                     borderRadius: '20px',
//                     padding: '28px 24px',
//                     boxShadow: '0 4px 20px rgba(6,182,212,0.11)',
//                     border: '2px solid #a5f3fc',
//                     transition: 'all 0.3s',
//                     position: 'relative',
...
//                         justifyContent: 'center'
//                       }}>
//                         <FileText size={24} style={{ color: '#0891b2' }} strokeWidth={2.5} />
//                       </div>
//                       <h3 style={{
//                         fontSize: '1.25rem',
//                         fontWeight: 800,
...
//                           border: `2px solid ${deletingId === resume._id ? '#cbd5e1' : '#fecaca'}`,
//                           borderRadius: '12px',
//                           fontSize: '0.95rem',
//                           fontWeight: 700,
//                           cursor: deletingId === resume._id ? 'not-allowed' : 'pointer',
...
//           }}>
//             <div style={{
//               background: 'linear-gradient(145deg, #fff1f2 0%, #ffe4e6 40%, #fce7f3 100%)',
//               padding: '40px 36px',
//               borderRadius: '24px',
//               boxShadow: '0 8px 48px rgba(244,114,182,0.3)',
//               minWidth: '380px',
//               maxWidth: '500px',
//               textAlign: 'center',
